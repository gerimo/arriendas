...
<div class="main_box_1">
    <div class="main_box_2">
        ...
        <div class="main_contenido">
            <h1 class="calen_titulo_seccion">Tus Reservas de Autos</span></h1>     
                ...
                <table class="misArriendos">
                    ...
                    <?php foreach ($toconfirm as $reserve): ?>
                        <tr>
                            ...
                            <td>
                            	<input type="checkbox" id="chkcontrato_<?php echo $reserve->getId()?>" value="1"><a target="_blank" href="<?php echo url_for('profile/agreePdf')?>?id=<?php echo $reserve->getCarId() ?>" class="vercontrato" id="<?php echo $reserve->getId()?>">Contrato</a><br/>
