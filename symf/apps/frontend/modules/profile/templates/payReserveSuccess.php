...
<div class="main_box_1">
    <div class="main_box_2">
        ...
        <div class="main_col_izq">
            ...
            <div class="usuario_foto_frame">
                ...
                <?php if ($user->getFacebookId() != NULL): ?>
                    <?= image_tag($user->getPictureFile() . '?type=large', 'size=129x147') ?>
                <?php elseif ($user->getPictureFile() != NULL): ?>
                    <?= image_tag("users/" . $user->getFileName(), 'size=129x147') ?>
                <?php else: ?>
                    <?= image_tag('img_registro/tmp_user_foto.jpg', 'size=129x147') ?>
                <?php endif; ?>
        ...
        <div class="main_contenido">
            ...
            <h1 class="calen_titulo_seccion">Informaci&oacute;n del pago</h1>   
            ...
            <div class="upcar_box_1">
                ...
                <div class="upcar_sector_1">
					...
					<input type="hidden" name="monto" id="monto" value="<? echo $reserve->getPrice(); ?>" />
					<input type="hidden" name="idtransaction" id="idtransaction" value="<? //echo $trans->getId(); ?>" />
                    ...
                    <div class="sector_1_form" style="width:450px">
                        ...
                        <div class="c1 height" style="width: 100%">
                                <a href="#" class="btnAmarillo" id="lnkPagar">Pagar</a>
                        </div><!-- /c1 --> 
