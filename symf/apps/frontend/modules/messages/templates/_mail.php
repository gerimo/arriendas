...
<div class="user_item <?=($mess->getReceived() == 0) ? "alert_mess_unread" : ""?> mensaje" onclick="window.location='<?=url_for("messages/conversation?id=".$mess->getConversationId()."&message_id=".$mess->getId())?>'">
