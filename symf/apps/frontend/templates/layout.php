  ...
  (function() {
    ...
    <body>
        ...
        <div class="body_bg">
			...
			<a class="item_thm fancybox" href="<?php echo url_for('main/referidos') ?>">Invita Amigos</a> 
                    </div>
			...
			<li><a href="http://www.arriendas.cl" target="_blank" class="item_1<?php
                        ...
                        ?>" title="Inicio - Ver Video Explciativa">
                            <span>Ver Video Explicativo</span></a></li>
...
<li><a href="https://arriendascl.zendesk.com/home" target="_blank" class="item_2"><span>Ayuda</span></a></li>
            ...
            <div class="footer">
			 ...
			 <!--   <li><a href="<?php echo url_for('main/terminos') ?>" title="Terminos y Condiciones">T&eacute;rminos y Condiciones</a></i> -->
                    ...
                    <p class="footer_copy">Arriendas.cl - Encomenderos 253, Las Condes, Santiago. - soporte AT arriendas.cl</p>
