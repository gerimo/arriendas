...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/XAMPP/xamppfiles/htdocs/test/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/test/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/XAMPP/xamppfiles/htdocs/test/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/test/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/XAMPP/xamppfiles/htdocs/test/apps/frontend/template',
)));
