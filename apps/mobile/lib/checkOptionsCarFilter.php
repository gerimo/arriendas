...
class CheckOptionsCarFilter extends sfFilter {
    ...
    public function execute($filterChain) {
        ...
        if ($this->isFirstCall() 
            ...
            && $action!='logout'
            && $action!='CarDisabledUntilDelete' 
            && $action!='CarAvailabilityDeleteChangeStatus'
            && $action!='carAvailabilitySave'
            && $action!='carAvailabilityDelete'
            && $action!='CarDisabledUntilSave'
            && $action!='getChecked'
            && $action!='toggleActiveCarAjax'
            && $action!='setActive') 
        {
