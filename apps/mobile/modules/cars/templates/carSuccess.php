...
<div class="main_contenido">
	...
	<div class="barraSuperior">
		...
		<div class="ladoIzquierdo">
			<div id="imagenPerfil">
				<?php echo image_tag("http://www.arriendas.cl/main/s3thumb?alto=185&ancho=185&urlFoto=".$car->getFoto(),array("width"=>"185","height"=>"185")); ?>
			</div>
			<?php 
				if($arrayFotos){
			?>
	...
	<div style="width: 256px;margin-bottom:50px; float: right;margin-left:0px;margin-right:30px;padding-right:10px;font-size:12px;">
		...
		<div class="titulo"><?php echo strtoupper($car->getModel()->getBrand())." ".strtoupper($car->getModel()); ?><?php if($car->autoVerificado()): ?><?php echo image_tag("verificado.png", "class=img_verificado title='Auto Asegurado' size=18x18"); ?><?php endif; ?></div>
