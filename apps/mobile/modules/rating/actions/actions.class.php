				...
				foreach ($Reserves as $Reserve) {
					...
					if(!$Rating){
						...
						if($isOwner){
							...
							$pendingListAsRenter = $pendingListAsRenter."<div class='visible-xs space-50'></div>";
							if($str > 0) {
							...
							$pendingListAsOwner = $pendingListAsOwner."<p><b>Nombre del arrendatario:</b> <br>".$Renter->getFirstname()." ".$Renter->getLastname()."</p>";
							$pendingListAsOwner = $pendingListAsOwner."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
							$pendingListAsOwner = $pendingListAsOwner."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
							$pendingListAsOwner = $pendingListAsOwner."</div>";
							$pendingListAsOwner = $pendingListAsOwner."</div>";
							$pendingListAsOwner = $pendingListAsOwner."<a class='btn btn-a-action btn-block btn-make-rate' href='".$this->generateUrl("rating_show_owner_form", array("reserveId" => $Reserve->id))."' class='reserve' target='_blank'>Calificar al arrendatario</a>";
							...
							$pendingListAsRenter = $pendingListAsRenter."<p><b>Nombre del dueño:</b> <br>".$Owner->getFirstname()." ".$Owner->getLastname()."</p>";
							$pendingListAsRenter = $pendingListAsRenter."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
							$pendingListAsRenter = $pendingListAsRenter."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
							$pendingListAsRenter = $pendingListAsRenter."</div>";
							$pendingListAsRenter = $pendingListAsRenter."</div>";
							$pendingListAsRenter = $pendingListAsRenter."<a class='btn btn-a-action btn-block btn-make-rate' href='".$this->generateUrl("rating_show_renter_form", array("reserveId" => $Reserve->id))."' class='reserve' target='_blank'>Calificar al dueño</a>";
					...
					if($Rating){
						...
						if($isOwner){
							...
							if($Rating->getStateOwner()){
								...
								$historyListAsOwner = $historyListAsOwner."<div class='visible-xs space-50'></div>";
								if($str > 0) {
								...
								$historyListAsOwner = $historyListAsOwner."<p><b>Nombre del arrendatario:</b> <br>".$Renter->getFirstname()." ".$Renter->getLastname()."</p>";
								$historyListAsOwner = $historyListAsOwner."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
								$historyListAsOwner = $historyListAsOwner."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
								$historyListAsOwner = $historyListAsOwner."<p><b>Calificacion:</b> <br> <span class='history-rate' data-score='".$Rating->getOpCleaningAboutRenter()."'></span></p>";
								$historyListAsOwner = $historyListAsOwner."</div>";
								$historyListAsOwner = $historyListAsOwner."</div>";
							...
							if($Rating->getStateRenter()){
								...
								$historyListAsRenter = $historyListAsRenter."<div class='visible-xs space-50'></div>";
								if($str > 0) {
								...
								$historyListAsRenter = $historyListAsRenter."<p><b>Nombre del Dueño:</b> <br>".$Owner->getFirstname()." ".$Owner->getLastname()."</p>";
								$historyListAsRenter = $historyListAsRenter."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
								$historyListAsRenter = $historyListAsRenter."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
								$historyListAsRenter = $historyListAsRenter."<p><b>Calificacion:</b> <br> <span class='history-rate' data-score='".$Rating->getOpCleaningAboutOwner()."'></span></p>";						
								$historyListAsRenter = $historyListAsRenter."</div>";
								$historyListAsRenter = $historyListAsRenter."</div>";
					...
					if($Rating){
						...
						if($isOwner){
							...
							if($Rating->getStateRenter()){
								...
								$historyListAsOwner = $historyListAsOwner."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
								$historyListAsOwner = $historyListAsOwner."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
								$historyListAsOwner = $historyListAsOwner."<p><b>Calificacion:</b> <br> <span class='history-rate' data-score='".$Rating->getOpCleaningAboutOwner()."'></span></p>";
								$historyListAsOwner = $historyListAsOwner."</div>";
								$historyListAsOwner = $historyListAsOwner."</div>";
								$historyListAsOwner = $historyListAsOwner."<br>";
								$historyListAsOwner = $historyListAsOwner."</article>";
							...
							if($Rating->getStateOwner()){
								...
								$historyListAsRenter = $historyListAsRenter."<p><b>Fecha de la reserva:</b> <br>".$Reserve->getFechaReserva()."</p>";
								$historyListAsRenter = $historyListAsRenter."<p><b>Fecha de fin:</b> <br>".$Reserve->getFechaTermino2()."</p>";
								$historyListAsRenter = $historyListAsRenter."<p><b>Calificacion:</b> <br> <span class='history-rate' data-score='".$Rating->getOpCleaningAboutRenter()."'></span></p>";						
								$historyListAsRenter = $historyListAsRenter."</div>";
								$historyListAsRenter = $historyListAsRenter."</div>";
								$historyListAsRenter = $historyListAsRenter."<br>";
								$historyListAsRenter = $historyListAsRenter."</article>";
