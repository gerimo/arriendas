<link href="/css/newDesign/mobile/carsMobile.css" rel="stylesheet" type="text/css">
                        ...
                        <div class="row">
                            ...
                            <?php if ($c->getActivo() == 0): ?>
                                <div class="col-md-3">
                                    ...
                                    <input class="disabled-until form-control" readonly="readonly"data-car-id="<?php echo $c->id ?>" type="text" value="<?php echo $c->getDisabledUntil() ? date('d-m-Y',strtotime($c->getDisabledUntil())): "";?>">
                                </div>
                            <?php endif ?>
                        </div>
