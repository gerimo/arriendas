...
class carActions extends sfActions {
	...
	public function executeGetActivesCars(sfWebRequest $request) {
	    ...
	    try {
	        ...
	        $Cars       = Doctrine_Core::getTable('Car')->findCars($Reserve->getFechaInicio2(), $Reserve->getFechaTermino2(), 300, false, false, false, false, false, 13, false, $isAutomatic, $isLowConsumption, $isMorePassengers, false);
