...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@car') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('car/form_actions', array('car' => $car, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
    ...
    endforeach; 
	    ...
	    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
	      <?php include_partial('car/form_fieldset', array('car' => $car, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
	    <?php endforeach; ?>
		</div>
