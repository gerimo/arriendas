	        ...
	        <div class="BCW clearfix">
            	...
            	<div class="row">
	            	<p class="text-center thumbnail">
	            		<a href="www.arriendas.cl">Arriendas</a> exije que adquieras un GPS. <br>
		            	Esto, para garantizar una mayor seguridad en tus arriendos.<br>
...
<form id="pay_form" method="POST" action="<?php echo url_for('gps/payGps') ?>">
