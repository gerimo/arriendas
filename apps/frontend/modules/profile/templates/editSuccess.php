...
<div style="display:none">
    ...
    <form action="<?php echo url_for('profile/uploadPhoto') ?>" enctype="multipart/form-data" id="formmain" name="formmain" method="post">
        <input id="filemain" name="filemain" type="file">
        <input type="submit">
    </form>

    <form action="<?php echo url_for('profile/uploadLicense') ?>" enctype="multipart/form-data" id="formlicense" method="post">
