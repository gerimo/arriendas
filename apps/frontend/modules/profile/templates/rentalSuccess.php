                ...
                <table class="misArriendos">
                    ...
                    <?php foreach ($toconfirm as $reserve): ?>
                        <tr>
                            ...
                            <td>
                            	<input type="checkbox" id="chkcontrato_<?php echo $reserve->getId()?>" value="1"><a target="_blank" href="<?php echo url_for('http://admin.arriendas.cl/api.php/contrato/generarContrato/idReserva/'.$reserve->getId())?>" class="vercontrato" id="<?php echo $reserve->getId()?>">Contrato</a><br/>
