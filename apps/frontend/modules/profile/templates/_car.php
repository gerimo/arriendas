...
<div class="upcar_box_1_header"><h2>Detalles del Auto</h2></div>
...
<div class="upcar_sector_1">
	...
	<div id="previewmain">
	<?php echo image_tag($car->getFoto(),array("width"=>"174px","height"=>"174px")); ?>
</div>
...
<!--
 <div class="c1">
	...
	<input type="text" id="km" name="km" value="<?php //echo $car->getKm()?>">
</label>
</div>
-->
