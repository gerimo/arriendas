...
<?php
	if(!$transaccionesRenter){
		echo "<p><span class='error'>No tiene transacciones registradas como Arrendatario</span></p><br>";
	}else{
?>	
	<p><span class="titulo_tabla">Transacciones como Arrendatario</span></p>
	<table>
		<tr>
...
<?php 
	...
	if(!$transaccionesOwner){
		echo "<p><span class='error'>No tiene transacciones registradas como Dueño</span></p><br>";
	}else{
?>
	<p><span class="titulo_tabla">Transacciones como Dueño</span></p>
	<table>
		<tr>
			<td class='titulo'>FECHA</td>
			<td class='titulo'>MONTO</td>
