                ...
                <div class="calen_box_3">
                    <div style="padding-top:20px; padding-left:20px;font-size:12px;width:505px;">
                        ...
                        <div style="max-width: 85%; text-align: right">
                            <button class="botonPagar arriendas_pink_btn arriendas_big_btn right" id="payBtn" data-carid="<?php echo $car->getId() ?>" data-userid="<?php echo $idUsuario ?>" style="position: initial">Reservar</button>
                            <br>
