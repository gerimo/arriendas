    ...
    <div class="container">
        ...
        <div class="row">   
            ...
            <!--<div class="col-md-5">
                        <h1 class="hidden-xs text-capitalize"><?php echo $Car->getModel()->getBrand()->getName()." ".$Car->getModel()->getName().", <span>".$Car->getPricePerDay()."</span>" ?></h1>
            ...
            <div class="col-xs-offset-0 col-xs-12 col-sn-12 col-md-offset-0 col-md-5 carousal-area">
                <h1 class="hidden-xs text-capitalize"><?php echo $Car->getModel()->getBrand()->getName()." ".$Car->getModel()->getName().", <span>".$Car->getCommune().","."</span>"." "."<span>".$Car->getYear()."</span>" ?></h1>
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                        <?php echo $Car->getPatente();?></br>
                        <p class = "hours"></p>
                        <?php echo $Car->getReserves()->getDuration();?></br>
                        <?php echo $Car->getSeguroFotoFrente();?>
                        <?php echo image_tag($Car->getSeguroFotoFrente(), 'size=194x204'); ?>
                        <?php echo image_tag('..    /uploads/cars/'.$Car->getSeguroFotoFrente()); ?>
                        <img class='car' src='http://res.cloudinary.com/arriendas-cl/image/fetch/w_134,h_99,c_fill,g_center/"<?php echo $Car->getSeguroFotoFrente()?>"' height='99' width='134' alt=''>
                        </div>
                    </div>
            ...
            <div class="hidden-xs hidden-sm col-md-3 car-sep">
                ...
                <ul id="features">
                    ...
                    <?php if ($transmission): ?>
                        <li><span class="icon-svg_06"></span> Automático</li>
                    <?php else: ?>
                        <li><span class="icon-svg"></span> Manual</li>
                    <?php endif ?>
                </ul>
                        ...
                        <li class="clearfix">
                            ...
                            <div class="info">
                                ...
                                <form action="<?php echo url_for('profile/pay') ?>" id="reserve-form" method="post">
                                    <!-- Resumen y garantía -->
                                    <div class="row">
                                        <div class="fake col-md-12">
                                            <ul id="fromTo">
                                                <input class="datetimepicker btn-block" id="from" type="button" value="<?php echo $fromHuman ?>"></input>
                                                <input class="datetimepicker btn-block" id="to" type="button" value="<?php echo $toHuman ?>"></input>
                                            </ul>
                                            ...
                                            <div id="warranty-container">
                                                ...
                                                <div class="price-count">
                                                    <div class="radio">
                                                        <label>
                                                            <input class="fake-input" data-price="<?php echo $amountWarranty ?>" name="warranty" type="radio" value="1">
                                                    ...
                                                    <?php if (!$isDebtor): ?>
                                                        <div class="radio">
                                                            <label>
                                                                <input class="fake-input" data-price="<?php echo $amountWarrantyFree ?>" name="warranty" type="radio" value="0">
        ...
        <div class= "row">
            ...
            <div class="col-xs-offse-0 col-xs-12 col-sm-offset-1 col-sm-11 col-md-offset-1 col-md-11" id="payments">

                <div class="col-xs-6 col-sm-4 col-md-4 radio">
                    <label>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 radio">
                    <label>
        ...
        <div class="row mob-none">
            <div class="hidden-xs col-sm-12">
                <ul class="list-option list-inline list-unstyled text-capitalize">
                    <li><span class="icon-svg_16"></span>Seguro </li>
                    <li><span class="icon-svg_16"></span>Tags </li>
                    <li><span class="icon-svg_16"></span>Conductor  </li>
                    <li><span class="icon-svg_16"></span>Adicional Kilometraje </li>
                    <li><span class="icon-svg_16"></span>Asistencia ruta 24/7 </li>
                    <li><span class="icon-svg_16"></span>Depósito en garantía opcional </li>
                </ul>
            </div>
            <div class="col-sm-offset-4  col-md-offset-7 ">
