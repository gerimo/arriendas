    ...
    <div class="main_box_2">
        ...
        <div class="main_contenido">
            ...
            <div id="sub_contenido" style="margin: 15px;margin-right: 25px;">
                ...
                <?php if (!is_null($telephone) && !empty($telephone)): ?>
                ...
                <?php else: ?>
                    <p style="text-align: center;margin-top: 25px; margin-bottom:30px; ;font-size: 17px;">Un inspector se contactará contigo para agendar la inspección en tu domicilio.</p>
                <?php endif; ?>
