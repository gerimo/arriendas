...
<div style="background-color: #00AEEF; text-align: center; width: 1020px; height: 100%; padding-top: 250px;">
	<div class="logo_arriendas"><?php echo image_tag('img_informeDanios/Logo.png', 'width=486', 'height=176') ?></div>
	<div class="logo_informe"><?php echo image_tag('img_informeDanios/LinPortada.png', 'width=486', 'height=92') ?>
...
<div style="background-color: white; text-align: center; margin: 0px auto; width: 1020px; margin-top: 10px;">
	...
	<?php echo image_tag('img_informeDanios/LinImportante.png', 'width=324', 'height=120') ?>
...
<div style="background-color: white;text-align: center;margin: 0px auto;width: 1020px;margin-top: 10px;">
	...
	<?php echo image_tag('img_informeDanios/LinFichaAuto.png', 'width=314', 'height=114') ?>
	...
	<?php
		...
		$auto = iniciarCURL();
	?>
	<div style="float: left;margin-left: 60px;margin-top: 20px;width: 239px;height: 239px;border-style: solid;border-width: 2px;border-color: black;"><?php echo image_tag($foto,array("width"=>"220","height"=>"220")); ?>
	...
	<div style="float: right; margin-right: 30px; margin-top: 20px; width: 300px; height: 800px; font-size: 10px;">
		...
		<div class="detalles">
			...
			<p style="font-size: 10px;"><?php  ?></p>
		</div>
	</div>
</div>
<pagebreak />

<?php for($j=0;$j<=$paginasDanios-1;$j++): ?>
<div>
	<div>
		<?php for($i=$j*2;$i<=min(count($danios)-1,$j*2+1);$i++): ?>
		<div>
			<div class='circulo'>
				<p><?php echo $i+1; ?></p>
			</div>
		...
		<div>
			<div style="float:left;" class='zonaDelDanio'>
				...
				<div>
					<?php echo image_tag(url_for("main/generarMapaDanio?idDanio=".$danios[$i]['id'].".jpg"),array("id"=>"fotoDanio","width"=>"300","height"=>"200")); ?>
				</div>
			</div>
			<div class='imagenDelDanio' style="float:left; position: absolute; width: 300px; height: 300px;">
				...
				<div class='imagen'>
				<img src="http://www.arriendas.cl/uploads/damages/<?php echo $danios[$i]->getUrlFoto(); ?>" width="300px"/>
				</div>
			</div>
		</div>
		<div>
			<h2 style="color: #00AEEF;">> Descripción del Daño</h2>
			<textarea name='descripcion' id='descripcion' cols='40' rows='4'><?php echo $danios[$i]->getDescription(); ?>
			</textarea>
		</div>
		<pagebreak />
		<?php endfor; ?>
