...
.search_ext_box { z-index: 1; display:none;}
...
<!--  busqueda avanzada -->
        ...
        <div class="search_box_1_header">
            ...
            <div class="search_box1_form">
                <input style="width:110px;margin-right:25px;" readonly="readonly" type="text" id="day_from" value="Dia de inicio"/>
				...
				<input style="width:110px;margin-right:25px;" readonly="readonly" type="text" id="day_to" value="Dia de entrega"/>
                <input style="width:110px;margin-right:25px;" readonly="readonly" type="text" id="hour_to"  value="Hora de entrega" />
            ...
            <select name="price" id="price" style="width:122px;margin-right:20px;" >
            ...
            -->
            <select name="brand" id="brand" style="width:122px;margin-right:22px;" >
...
<li class="search_arecomend_marca"><a href="<?php echo url_for('cars/car?id=' . $c->getId() )?>"><?=$c->getBrand()?> <?=$c->getModel()?> </a></li>
