...
<div class="group_form">
 <?php echo form_tag('main/doActivate', array('method'=>'post', 'id'=>'frm1')); ?>

<div class="login_box">
    <div class="login_box_somb_izq"></div>
    <div class="login_box_somb_dere"></div>
	<br/><br/>
    <h2>Su cuenta se encuentra inactiva?</h2>
    <p>Ingrese su correo elecctronico y le enviaremos un link para que pueda activarla.</p>
   	<div class="login_formulario">
    	<!-- form -->
	        <div class="c1">
	        	<input type="text" id="email" name="email" value="Ingrese email"onfocus="checkclear(this)"/>
	        </div>
	        	<button class="login_btn_conectar" onclick="submitFrom()" >Enviar</button>
