<link href="/css/newDesign/pricesCompare.css" rel="stylesheet" type="text/css">
            ...
            <section id="section-compare-prices">
               ...
               <div class="row">
                ...
                <div class="hidden-xs col-sm-offset-2 col-sm-8 col-md-offset-1 col-md-10 text-center">
                    <p class = "small text-table">Precios con IVA, aplicando descuento por reservas en internet, con seguro de daños, 
