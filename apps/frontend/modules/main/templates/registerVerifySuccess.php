<link href="/css/newDesign/registerVerify.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        $.post("<?php echo url_for('main/completeRegisterVerify') ?>", {"como": como, "userId": userId, "rut": rut, "foreign": foreign, "telephone": telephone, "birth": birth, "address": address, "commune": commune, "region": region}, function(r){
