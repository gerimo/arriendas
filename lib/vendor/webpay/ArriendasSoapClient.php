...
class ArriendasSoapClient extends SoapClient {
    ...
    function __doRequest($request, $location, $action, $version, $oneWay = 0) {
        ...
        $PRIVATE_KEY_PATH = sfConfig::get('sf_lib_dir') . "/vendor/webpay/certificates/arriendasProd.key";
        $CERT_FILE_PATH = sfConfig::get('sf_lib_dir') . "/vendor/webpay/certificates/arriendasProd.crt";
