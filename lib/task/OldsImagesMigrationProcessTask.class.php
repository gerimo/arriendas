...
class OldsImagesMigrationProcessTask extends sfBaseTask {
    ...
    protected function configure() {
        ...
        $this->name = 'OldsImagesMigrationProcess';
        $this->briefDescription = 'Busca y procesa las imagenes de las entidades que no hayan subido imágenes a s3';
