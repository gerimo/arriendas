...
/**
 * ModelPrice form base class.
 *
 * @method ModelPrice getObject() Returns the current form's model object
 *
 * @package    CarSharing
 * @subpackage form
 ...
 */
abstract class BaseModelPriceForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'ModelPrice', 'column' => array('id')))
    );

    $this->widgetSchema->setNameFormat('model_price[%s]');
